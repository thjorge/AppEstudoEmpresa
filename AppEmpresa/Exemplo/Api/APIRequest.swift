...
public class APIRequest {
    ...
    func showErrorMessage(error: API.RequestError) {
        ...
        DispatchQueue.main.async {
            ...
            //as linhas acima foram comentadas para nao mostrarem popup no login. se quiser fazer validacao com popup, pode descomenta-las
            print("ERRO DA REQUISICAO: \(errorMessage)")
        }
    }
