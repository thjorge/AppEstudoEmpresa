...
class MappableTests: XCTestCase {
    ...
    func testModels() {
        ...
        let testDictionary = try! JSONSerialization.jsonObject(with: try! Data(contentsOf: bundle.url(forResource: "mappableTestDictionary", withExtension: "json")!), options: []) as! [String: Any]
